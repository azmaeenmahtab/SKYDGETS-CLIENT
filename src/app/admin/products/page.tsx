    ...
    <div className="flex flex-col w-full min-h-screen bg-white text-zinc-900">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-28 sm:pt-32 pb-16 sm:px-6 lg:px-8 w-full space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-zinc-200/80">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <Link
              href="/items/add"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-zinc-100 hover:bg-zinc-200 text-zinc-900 font-bold text-xs uppercase tracking-wider transition-all border border-zinc-200/80 active:scale-95 cursor-pointer shadow-sm"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-zinc-950 hover:bg-zinc-800 text-white font-extrabold text-xs uppercase tracking-wider transition-all shadow-lg active:scale-95 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {/* Total Products */}
          <div className="p-5 rounded-3xl bg-white border border-zinc-200/80 shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-3">
              ...
              <p className="text-[11px] text-zinc-500 mt-0.5">In catalog store</p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-3xl bg-white border border-zinc-200/80 shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-3">
              ...
              <p className="text-[11px] text-zinc-500 mt-0.5">Live for purchase</p>
            </div>
          </div>
          ...
          {/* Inventory Valuation */}
          <div className="p-5 rounded-3xl bg-white border border-zinc-200/80 shadow-sm flex flex-col justify-between col-span-2 lg:col-span-1">
            <div className="flex items-center justify-between text-zinc-400">
              <span className="text-xs font-bold uppercase tracking-wider">Inventory Value</span>
              <TrendingUp className="w-4 h-4 text-blue-500" />
            </div>
            <div className="mt-3">
              <span className="text-xl font-black text-zinc-950 truncate block">
                {formatPrice(stats.totalValuation)}
              </span>
              <p className="text-[11px] text-zinc-500 mt-0.5">Total stock value</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-2xl text-sm text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all font-medium"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="flex items-center bg-zinc-100 p-1 rounded-2xl border border-zinc-200/80">
                <button
              ...
              <button
                onClick={() => refetch()}
                disabled={isFetching}
                className="p-2.5 rounded-2xl bg-zinc-50 border border-zinc-200 text-zinc-600 hover:text-zinc-950 transition-all cursor-pointer disabled:opacity-50"
          ...
          <div className="p-4 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex flex-col sm:flex-row items-center justify-between gap-4 animate-in fade-in duration-200 shadow-lg">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl text-xs font-semibold text-zinc-500 hover:text-zinc-950 transition-colors cursor-pointer"
              >
                Deselect All
              </button>
            </div>
        ...
        {isLoading ? (
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="h-20 rounded-2xl bg-zinc-100 animate-pulse border border-zinc-200/60"
              />
            ))}
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-20 px-4 text-center bg-white border border-zinc-200/80 rounded-3xl shadow-sm">
            ...
            <button
              onClick={resetFilters}
              className="px-6 py-2.5 bg-zinc-950 hover:bg-zinc-800 text-white text-xs font-bold uppercase tracking-wider rounded-full shadow-md cursor-pointer"
            >
              Clear Filters
            </button>
          </div>
          ...
          /* TABLE VIEW */
          <div className="rounded-3xl bg-white border border-zinc-200/80 overflow-hidden shadow-sm">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="border-b border-zinc-200/80 bg-zinc-50/70 text-[11px] font-mono font-bold uppercase tracking-wider text-zinc-500">
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-3 max-w-md">
                            <div className="relative w-12 h-12 rounded-xl overflow-hidden bg-zinc-100 border border-zinc-200/60 flex-shrink-0">
                              <img
                                src={primaryImg}
                                alt={product.title}
                            ...
                            <div className="min-w-0">
                              <Link
                                ...
                                className="font-bold text-zinc-950 hover:text-purple-600 transition-colors line-clamp-1 text-sm"
                                title={product.title}
                              >
                                {product.title}
                              </Link>
                        ...
                        <td className="py-4 px-4">
                          <div className="flex flex-col gap-1 items-start">
                            <span className="text-xs font-semibold text-zinc-600 bg-zinc-100 px-2.5 py-0.5 rounded-full">
                              {product.categoryPath || "Gadgets"}
                            </span>
                            <span className="text-[11px] font-mono text-purple-600 capitalize">
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="font-bold text-xs text-zinc-900 tabular-nums">
                        ...
                        <td className="py-4 px-4 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-zinc-500 hover:text-purple-600 hover:bg-zinc-100 transition-colors cursor-pointer"
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-zinc-500 hover:text-purple-600 hover:bg-zinc-100 transition-colors cursor-pointer disabled:opacity-50"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-start">
            {processedProducts.map((product) => {
              ...
              return (
                <div
                  key={product._id}
                  className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-zinc-200/80 bg-white p-4 transition-all duration-300 shadow-sm hover:shadow-xl"
                >
                  <div>
                    {/* Thumbnail canvas */}
                    <div className="relative aspect-video w-full overflow-hidden rounded-2xl bg-zinc-100 mb-3">
                      <img
                        src={primaryImg}
                        alt={product.title}
                    ...
                    <h3 className="text-base font-extrabold text-zinc-950 line-clamp-1 mt-0.5">
                      {product.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between gap-2 mt-4 pt-3 border-t border-zinc-100">
                    <button
                      onClick={() => openQuickEdit(product)}
                      className="px-3 py-1.5 rounded-xl bg-zinc-100 hover:bg-purple-500/10 text-xs font-bold text-zinc-900 hover:text-purple-600 transition-colors flex items-center gap-1 cursor-pointer"
                    >
                    ...
                    <div className="flex items-center gap-1">
                      <Link
                        href={`/admin/products/${product._id}/edit`}
                        className="p-1.5 rounded-lg text-zinc-400 hover:text-purple-600"
                      >
                        <Edit3 className="w-4 h-4" />
                      </Link>
                      <button
      ...
      {quickEditProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="w-full max-w-md bg-white rounded-3xl border border-zinc-200 p-6 shadow-2xl space-y-5">
            ...
            <p className="text-xs text-zinc-500 truncate">
              Updating: <span className="font-bold text-zinc-950">{quickEditProduct.title}</span>
            </p>
            ...
            <form onSubmit={handleQuickEditSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-2.5 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-purple-500 font-bold"
                />
              </div>
              ...
              <div className="flex items-center gap-3 pt-3">
                <button
                  type="button"
                  onClick={() => setQuickEditProduct(null)}
                  className="flex-1 py-3 rounded-full bg-zinc-100 hover:bg-zinc-200 text-zinc-800 font-bold text-xs uppercase tracking-wider transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3 rounded-full bg-zinc-950 hover:bg-zinc-800 text-white font-extrabold text-xs uppercase tracking-wider transition-all shadow-lg cursor-pointer disabled:opacity-50"
                >
      ...
      {deleteConfirmProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="w-full max-w-md bg-white rounded-3xl border border-zinc-200 p-6 shadow-2xl space-y-4 text-center">
            ...
            <p className="text-xs text-zinc-500">
              Are you sure you want to delete <span className="font-bold text-zinc-950">"{deleteConfirmProduct.title}"</span>? This action cannot be undone.
            </p>
